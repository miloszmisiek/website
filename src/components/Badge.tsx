...
const badge = cva(
  "inline-flex items-center whitespace-nowrap font-mono text-micro short:text-[11px] tracking-widest short:tracking-wider uppercase px-2.5 py-1 short:px-2 short:py-1 rounded-none border border-solid transition-colors",
  {
    variants: {
      variant: {
        neutral:
        ...
        restricted:
          "bg-foreground/[0.04] text-foreground/70 border-foreground/30",
      },
    },
    defaultVariants: {
      variant: "neutral",
